...
class Settings(BaseSettings):
    ...
    grok2api_url: str = Field("", alias="GROK2API_URL")
    grok2api_api_key: str = Field("", alias="GROK2API_API_KEY")
    grok2api_model: str = Field("grok-4.20-0309-non-reasoning", alias="GROK2API_MODEL")
    grok2api_fallback_models: str = Field("", alias="GROK2API_FALLBACK_MODELS")
